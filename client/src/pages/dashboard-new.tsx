        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-4 gap-8 justify-items-center">
            <Link href="/calculator">
              <div className="group w-40 h-40 bg-white/20 backdrop-blur-md border border-white/30 rounded-full hover:bg-white/30 hover:border-orange-500/50 hover:scale-110 transition-all duration-300 cursor-pointer shadow-xl hover:shadow-2xl action-card-bounce action-card-rotate" style={{"--delay": 4} as React.CSSProperties}>
            ...
            <Link href="/commission-tracker">
              <div className="group w-40 h-40 bg-white/20 backdrop-blur-md border border-white/30 rounded-full hover:bg-white/30 hover:border-orange-500/50 hover:scale-110 transition-all duration-300 cursor-pointer shadow-xl hover:shadow-2xl action-card-bounce action-card-rotate" style={{"--delay": 5} as React.CSSProperties}>
                <div className="action-card-content">
            ...
            <Link href="/client-intel">
              <div className="group w-40 h-40 bg-white/20 backdrop-blur-md border border-white/30 rounded-full hover:bg-white/30 hover:border-orange-500/50 hover:scale-110 transition-all duration-300 cursor-pointer shadow-xl hover:shadow-2xl action-card-bounce action-card-rotate" style={{"--delay": 6} as React.CSSProperties}>
                <div className="action-card-content">
            ...
            <div className="group w-40 h-40 bg-white/20 backdrop-blur-md border border-white/30 rounded-full hover:bg-white/30 hover:border-orange-500/50 hover:scale-110 transition-all duration-300 cursor-pointer shadow-xl hover:shadow-2xl action-card-bounce action-card-rotate" style={{"--delay": 7} as React.CSSProperties}>
              <div className="action-card-content">
